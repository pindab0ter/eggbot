...
fun Double.formatIllionsLong(rounded: Boolean = false): String {
    val f = if (rounded) integerFormat else decimalFormat
    return when (this) {
        in (1.0e006..1.0e009 - 1) -> f.format(this / 1e006) + " Million"
        in (1.0e009..1.0e012 - 1) -> f.format(this / 1e009) + " Billion"
        in (1.0e012..1.0e015 - 1) -> f.format(this / 1e012) + " Trillion"
        in (1.0e015..1.0e018 - 1) -> f.format(this / 1e015) + " Quadrillion"
        in (1.0e018..1.0e021 - 1) -> f.format(this / 1e018) + " Quintillion"
        in (1.0e021..1.0e024 - 1) -> f.format(this / 1e021) + " Sextillion"
        in (1.0e024..1.0e027 - 1) -> f.format(this / 1e024) + " Septillion"
        in (1.0e027..1.0e030 - 1) -> f.format(this / 1e027) + " Octillion"
        in (1.0e030..1.0e033 - 1) -> f.format(this / 1e030) + " Nonillion"
        in (1.0e033..1.0e036 - 1) -> f.format(this / 1e033) + " Decillion"
        in (1.0e036..1.0e039 - 1) -> f.format(this / 1e036) + " Undecillion"
        in (1.0e039..1.0e042 - 1) -> f.format(this / 1e039) + " Duodecillion"
        in (1.0e042..1.0e045 - 1) -> f.format(this / 1e042) + " Tredecillion"
        in (1.0e045..1.0e048 - 1) -> f.format(this / 1e045) + " Quattuordecillion"
        in (1.0e048..1.0e051 - 1) -> f.format(this / 1e048) + " Quinquadecillion"
        in (1.0e051..1.0e054 - 1) -> f.format(this / 1e051) + " Sedecillion"
        in (1.0e054..1.0e057 - 1) -> f.format(this / 1e054) + " Septendecillion"
        in (1.0e057..1.0e060 - 1) -> f.format(this / 1e057) + " Octodecillion"
        in (1.0e060..1.0e063 - 1) -> f.format(this / 1e060) + " Novendecillion"
        in (1.0e063..1.0e066 - 1) -> f.format(this / 1e063) + " Vigintillion"
        in (1.0e066..1.0e069 - 1) -> f.format(this / 1e066) + " Unvigintillion"
        in (1.0e069..1.0e072 - 1) -> f.format(this / 1e069) + " Duovigintillion"
        in (1.0e072..1.0e075 - 1) -> f.format(this / 1e072) + " Tresvigintillion"
        in (1.0e075..1.0e078 - 1) -> f.format(this / 1e075) + " Quattuorvigintillion"
        in (1.0e078..1.0e081 - 1) -> f.format(this / 1e078) + " Quinquavigintillion"
        in (1.0e081..1.0e084 - 1) -> f.format(this / 1e081) + " Sesvigintillion"
        in (1.0e084..1.0e087 - 1) -> f.format(this / 1e084) + " Septemvigintillion"
        in (1.0e087..1.0e090 - 1) -> f.format(this / 1e087) + " Octovigintillion"
        in (1.0e090..1.0e093 - 1) -> f.format(this / 1e090) + " Novemvigintillion"
        in (1.0e093..1.0e096 - 1) -> f.format(this / 1e093) + " Trigintillion"
        in (1.0e096..1.0e099 - 1) -> f.format(this / 1e096) + " Untrigintillion"
        in (1.0e099..1.0e102 - 1) -> f.format(this / 1e099) + " Duotrigintillion"
        in (1.0e102..1.0e105 - 1) -> f.format(this / 1e102) + " Trestrigintillion"
        in (1.0e105..1.0e108 - 1) -> f.format(this / 1e105) + " Quattuortrigintillion"
        in (1.0e108..1.0e111 - 1) -> f.format(this / 1e108) + " Quinquatrigintillion"
        in (1.0e111..1.0e114 - 1) -> f.format(this / 1e111) + " Sestrigintillion"
        in (1.0e114..1.0e117 - 1) -> f.format(this / 1e114) + " Septentrigintillion"
        in (1.0e117..1.0e120 - 1) -> f.format(this / 1e117) + " Octotrigintillion"
        in (1.0e120..1.0e123 - 1) -> f.format(this / 1e120) + " Noventrigintillion"
        else -> f.format(this)
    }
}
...
fun BigDecimal.formatIllionsLong(rounded: Boolean = false): String {
    val f = if (rounded) integerFormat else decimalFormat
    return when (this) {
        in (TEN.pow(6)..TEN.pow(9) - ONE) -> f.format(this / TEN.pow(6)) + " Million"
        in (TEN.pow(9)..TEN.pow(12) - ONE) -> f.format(this / TEN.pow(9)) + " Billion"
        in (TEN.pow(12)..TEN.pow(15) - ONE) -> f.format(this / TEN.pow(12)) + " Trillion"
        in (TEN.pow(15)..TEN.pow(18) - ONE) -> f.format(this / TEN.pow(15)) + " Quadrillion"
        in (TEN.pow(18)..TEN.pow(21) - ONE) -> f.format(this / TEN.pow(18)) + " Quintillion"
        in (TEN.pow(21)..TEN.pow(24) - ONE) -> f.format(this / TEN.pow(21)) + " Sextillion"
        in (TEN.pow(24)..TEN.pow(27) - ONE) -> f.format(this / TEN.pow(24)) + " Septillion"
        in (TEN.pow(27)..TEN.pow(30) - ONE) -> f.format(this / TEN.pow(27)) + " Octillion"
        in (TEN.pow(30)..TEN.pow(33) - ONE) -> f.format(this / TEN.pow(30)) + " Nonillion"
        in (TEN.pow(33)..TEN.pow(36) - ONE) -> f.format(this / TEN.pow(33)) + " Decillion"
        in (TEN.pow(36)..TEN.pow(39) - ONE) -> f.format(this / TEN.pow(36)) + " Undecillion"
        in (TEN.pow(39)..TEN.pow(42) - ONE) -> f.format(this / TEN.pow(39)) + " Duodecillion"
        in (TEN.pow(42)..TEN.pow(45) - ONE) -> f.format(this / TEN.pow(42)) + " Tredecillion"
        in (TEN.pow(45)..TEN.pow(48) - ONE) -> f.format(this / TEN.pow(45)) + " Quattuordecillion"
        in (TEN.pow(48)..TEN.pow(51) - ONE) -> f.format(this / TEN.pow(48)) + " Quinquadecillion"
        in (TEN.pow(51)..TEN.pow(54) - ONE) -> f.format(this / TEN.pow(51)) + " Sedecillion"
        in (TEN.pow(54)..TEN.pow(57) - ONE) -> f.format(this / TEN.pow(54)) + " Septendecillion"
        in (TEN.pow(57)..TEN.pow(60) - ONE) -> f.format(this / TEN.pow(57)) + " Octodecillion"
        in (TEN.pow(60)..TEN.pow(63) - ONE) -> f.format(this / TEN.pow(60)) + " Novendecillion"
        in (TEN.pow(63)..TEN.pow(66) - ONE) -> f.format(this / TEN.pow(63)) + " Vigintillion"
        in (TEN.pow(66)..TEN.pow(69) - ONE) -> f.format(this / TEN.pow(66)) + " Unvigintillion"
        in (TEN.pow(69)..TEN.pow(72) - ONE) -> f.format(this / TEN.pow(69)) + " Duovigintillion"
        in (TEN.pow(72)..TEN.pow(75) - ONE) -> f.format(this / TEN.pow(72)) + " Tresvigintillion"
        in (TEN.pow(75)..TEN.pow(78) - ONE) -> f.format(this / TEN.pow(75)) + " Quattuorvigintillion"
        in (TEN.pow(78)..TEN.pow(81) - ONE) -> f.format(this / TEN.pow(78)) + " Quinquavigintillion"
        in (TEN.pow(81)..TEN.pow(84) - ONE) -> f.format(this / TEN.pow(81)) + " Sesvigintillion"
        in (TEN.pow(84)..TEN.pow(87) - ONE) -> f.format(this / TEN.pow(84)) + " Septemvigintillion"
        in (TEN.pow(87)..TEN.pow(90) - ONE) -> f.format(this / TEN.pow(87)) + " Octovigintillion"
        in (TEN.pow(90)..TEN.pow(93) - ONE) -> f.format(this / TEN.pow(90)) + " Novemvigintillion"
        in (TEN.pow(93)..TEN.pow(96) - ONE) -> f.format(this / TEN.pow(93)) + " Trigintillion"
        in (TEN.pow(96)..TEN.pow(99) - ONE) -> f.format(this / TEN.pow(96)) + " Untrigintillion"
        in (TEN.pow(99)..TEN.pow(102) - ONE) -> f.format(this / TEN.pow(99)) + " Duotrigintillion"
        in (TEN.pow(102)..TEN.pow(105) - ONE) -> f.format(this / TEN.pow(102)) + " Trestrigintillion"
        in (TEN.pow(105)..TEN.pow(108) - ONE) -> f.format(this / TEN.pow(105)) + " Quattuortrigintillion"
        in (TEN.pow(108)..TEN.pow(111) - ONE) -> f.format(this / TEN.pow(108)) + " Quinquatrigintillion"
        in (TEN.pow(111)..TEN.pow(114) - ONE) -> f.format(this / TEN.pow(111)) + " Sestrigintillion"
        in (TEN.pow(114)..TEN.pow(117) - ONE) -> f.format(this / TEN.pow(114)) + " Septentrigintillion"
        in (TEN.pow(117)..TEN.pow(120) - ONE) -> f.format(this / TEN.pow(117)) + " Octotrigintillion"
        in (TEN.pow(120)..TEN.pow(123) - ONE) -> f.format(this / TEN.pow(120)) + " Noventrigintillion"
        else -> f.format(this)
    }
}
